public abstract class Pet extends Animal implements HomePet{
    ...
    protected Pet(String name, String breed, String vaccination, String color, String dateBirthday, int height, int weight, String colorEye) {
